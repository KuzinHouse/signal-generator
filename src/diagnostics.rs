...
pub fn build_diagnostics(
    ...
    vec![
        ...
        FlatEntry::new("system_mqtt", "MQTT подключение", if mqtt_connected { "connected" } else { "disconnected" }),
        ...
        FlatEntry::new("system_generators_modbus", "Генераторов Modbus", modbus_count),
        FlatEntry::new("system_avg_interval_ms", "Средний интервал (мс)", avg_interval),
        FlatEntry::new("system_signal_rate_hz", "Частота сигналов (Гц)", (signal_rate_hz * 10.0).round() / 10.0),
